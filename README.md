...
- <img src="https://www.savemarkdown.co/favicon.png" height="14"/> [Save](https://github.com/jswallez/save-markdown) - Save any webpage as clean Markdown to a local vault and expose it to Claude via a built-in MCP server. Chrome extension + macOS menu bar app. Obsidian-compatible.
